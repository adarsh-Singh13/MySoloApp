      ...
      <GestureDetector gesture={swipes}>
        <View style={styles.pageContent}>
          ...
          <View style={styles.pageFooter}>
            <Animated.Text entering={SlideInLeft.delay(1000)}  style={styles.title}>{data.title}</Animated.Text>
            <Animated.Text entering={SlideInRight.delay(1000)}  style={styles.description}>{data.description}</Animated.Text>
